...
- Expected outputs: private corpus fixture registry, expected result snapshots, provider regression runner. Implemented as `docs/reference/data/parser_corpus_fixture_ledger.*`, `docs/reference/data/parser_provider_presets_v1.json`, and `tools/run_parser_corpus.py`. Latest generated regression data records MP OCR coverage and three remaining `UNKNOWN` evidence/image-pack review cases.
