...
1. **Unified Platform (`unified-platform/`)**
   ...
   - *Infrastructure Facts*: Replaces the legacy local Z-drive network sharing setup documented in the handover evidence, including a `Report Images` share and password-protected Windows account access, with cloud storage hooks.
