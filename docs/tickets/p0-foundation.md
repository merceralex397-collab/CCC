...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `docs/reference/generated-packs/`, `docs/research/*.md`, `docs/reference/test-context/testprojectcontext/`.
- Dependencies: none.
- Expected outputs: `docs/planning/source_synthesis.md`, promoted phase backlog, parked/superseded list.
...
- Verification: scaffold verifier checks generated pack and research references.
- Archive target: `archive/plans/implemented/` when implemented.
...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `ce_system_plans_enhanced/05_WORK_PACKAGE_DATA_MODEL_AND_WORKFLOW.md`, `phase7_expanded_markdown_plan/additional_items/08_01_work_item_state_store_and_job_sheet_replacement.md`, `08_04_human_review_queue_and_exception_sla.md`.
- Dependencies: P0-001.
...
- Verification: required contract files exist and contain versioned headings.
...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `collisionrelateddocs/Settings Backup/providers.json`, `docs/data/provider_coverage_matrix.md`, `ce_system_plans_enhanced/12_WORK_PACKAGE_PROVIDER_SETTINGS_AND_MIGRATION.md`.
- Dependencies: P0-002.
...
- Verification: scaffold verifier checks 26 provider presets and uncovered principal evidence.
- Archive target: `archive/plans/implemented/`.
...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `docs/research/siderpdf.md`, `docs/research/gptdeepresearch.md`, `cedocumentmapper_rebuild_plan_pack_all_zips/`, `collisionrelateddocs/claudechat.md`.
- Dependencies: P0-002, P0-003.
- Expected outputs: `docs/plans/parser_mvp_implementation_plan.md`.
...
- Verification: scaffold verifier checks parser-plan coverage terms and provider list.
- Archive target: `archive/plans/implemented/` after parser MVP is implemented and plan is marked implemented.
...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `phase7_expanded_markdown_plan/additional_items/08_11_monitoring_runbooks_and_release_management.md`, `08_12_security_dpia_and_vendor_governance.md`, `ce_phase4_agents_reviewed_plan/10_security_governance_audit.md`.
- Dependencies: P0-001.
...
- Verification: required security/operations docs exist and mention no personal injury or KADOE scope.
- Archive target: `archive/plans/implemented/`.
...
- Owner: TBD.
- Created: 2026-05-23.
- Sources: `ce_phase4_agents_reviewed_plan/12_open_questions_decision_log.md`, `docs/architecture/parser_ui_cli.md`, research docs.
- Dependencies: P0-001.
...
- Verification: scaffold verifier checks ADR and option files exist.
- Archive target: `archive/plans/implemented/`.
