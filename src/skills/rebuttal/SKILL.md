---
name: rebuttal
description: Use when drafting a Collision Engineers rebuttal to a diminution-in-value claim (e.g. an EVA / Exclusive Vehicle Assessors diminution report) for an instructing solicitor. Produces a CPR Part 35-style rebuttal report in CE house style. Triggers on "diminution", "rebuttal", "diminution in value", "EVA diminution".
---
