...
- **Services rendered** — itemised lines describing the expert/engineering work (e.g. report preparation, inspection, addendum, rebuttal).
- **Time / rate lines** — where charged on time: hours × rate; cite `abp-rates` where an ABP-aligned charge applies.
- **Expenses / disbursements** — travel, search fees, etc.
- **Totals** — net, VAT (state the rate; default 20% unless exempt), gross.
- **Payment terms** — due date / terms; remittance details.
